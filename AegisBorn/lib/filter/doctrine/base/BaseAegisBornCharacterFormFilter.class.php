...
abstract class BaseAegisBornCharacterFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'position_z' => new sfWidgetFormFilterInput(),
      'str'        => new sfWidgetFormFilterInput(),
      'agi'        => new sfWidgetFormFilterInput(),
      'vit'        => new sfWidgetFormFilterInput(),
      '_int'       => new sfWidgetFormFilterInput(),
      'dex'        => new sfWidgetFormFilterInput(),
      'luk'        => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'position_z' => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
      ...
      'vit'        => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
      '_int'       => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
      'dex'        => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
      'luk'        => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
