...
abstract class BaseAegisBornCharacterForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'position_z' => new sfWidgetFormInputText(),
      'str'        => new sfWidgetFormInputText(),
      'agi'        => new sfWidgetFormInputText(),
      'vit'        => new sfWidgetFormInputText(),
      '_int'       => new sfWidgetFormInputText(),
      'dex'        => new sfWidgetFormInputText(),
      'luk'        => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'position_z' => new sfValidatorInteger(array('required' => false)),
      'str'        => new sfValidatorInteger(array('required' => false)),
      'agi'        => new sfValidatorInteger(array('required' => false)),
      'vit'        => new sfValidatorInteger(array('required' => false)),
      '_int'       => new sfValidatorInteger(array('required' => false)),
      'dex'        => new sfValidatorInteger(array('required' => false)),
      'luk'        => new sfValidatorInteger(array('required' => false)),
